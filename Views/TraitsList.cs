...
namespace AiTaS.Controllers
{
    public class Traits 
    {
        ...
        public static Dictionary<string, string[]> TraitsList = new Dictionary<string, string[]>
        {
            ...
            //4: Whether the trait allows the player to specialize
            //5: Character Points Cost - Minor = 1, Major = 2, Special = variable
            //6: Skill Point Cost - Only for special traits(?)
            //7: Story Points Cost - Only for special traits(?)
            //8: Description of trait
            //9: Effects
            ...
            { "Inexperienced", new [] { 
                ...
                "2",
                "-3",
                //The story point value is negative here because it ADDS 3 story points.
            ...
            { "Psychic", new [] { 
                ...
                "0",
                "0",
                //Set this to lower character point cost by 1 if player takes Psychic Training trait.
            ...
            { "Robot (Disguised Appearance)", new [] { 
                "Good", 
                "Special", 
                "core book",
                "one time",
